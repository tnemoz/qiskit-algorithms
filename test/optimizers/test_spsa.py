...
from qiskit_algorithms.optimizers import QNSPSA, SPSA
...
class TestSPSA(QiskitAlgorithmsTestCase):
    ...
    def setUp(self):
        super().setUp()
        self.gen = np.random.default_rng(12)
    ...
    def test_termination_checker(self):
        ...
        def objective(x):
            return np.linalg.norm(x) + self.gen.random(1)
    ...
    def test_qnspsa_fidelity_primitives(self):
        ...
        initial_point = self.gen.random(ansatz.num_parameters)
